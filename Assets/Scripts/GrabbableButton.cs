...
{
    public class GrabbableButton : PointableElement, IGrabbable
    {
        ...
        protected override void Start()
        {
                ...
                TwoGrabTransformer == null)
            {
                ...
                OneGrabTransformer.Initialize(this);
                UnityEngine.Debug.Log("bruh moment"); // init
            }
            rend = GetComponent<Renderer>();
            if (rend != null)
            {
                originalColor = rend.material.color;
                UnityEngine.Debug.Log("saving original color...");
            }
            else
            {
                UnityEngine.Debug.Log("renderer is null!!!");
            }
        ...
        private void BeginTransform()
        {
            ...
            if (rend != null)
            {
                rend.material.color = grabColor; // Change color on grab
        ...
        private void EndTransform()
        {
            ...
            if (rend != null)
            {
                rend.material.color = originalColor; // Revert to original color on release
                UnityEngine.Debug.Log("changing back to original...");
            }
